defmodule MockForum.Web.Endpoint do
  ...
  plug Plug.Static,
    at: "/", from: :mock_forum_web, gzip: false,
    only: ~w(scss css fonts images js favicon.ico robots.txt)
  ...
  plug Plug.Session,
    store: :cookie,
    key: "_mock_forum_web_key",
    signing_salt: "T8PAcIR0"

  plug MockForum.Web.Router
